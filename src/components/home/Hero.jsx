...
const Hero = () => {
  ...
  return (
    <section
      className='py-12 xl:py-24 lg:h-[84vh]  min-h-full xl:pt-28 bg-hero bg-no-repeat bg-bottom bg-cover dark:bg-none'
      data-aos='fade-right'
    >
      <div className='container mx-auto'>
        <div className='flex justify-between gap-x-8'>
          {/* text */}
          <div className='flex max-w-[600px] flex-col mx-auto xl:mx-0'>
            <img
            ...
            <p className='subtitle max-w-[490px] mx-auto xl:mx-0'>
              Votre expert en solutions hydrauliques et pneumatiques, de la
              conception à la mise en service, pour des performances optimales
              et durables.
            </p>
            {/* buttons */}
